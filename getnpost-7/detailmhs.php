...
if( !isset($_GET["nama"]) || !isset($_GET["nim"]) || !isset($_GET["email"])  || !isset($_GET["jurusan"])) {  // jadi ketika block dibikin if not issect + variabel, belum dibikin kita lakukan sesuatu yaitu, kita paksa/pindahkan user untuk pindah dari hal 2 ke halaman 1 yaitu redirect., 
